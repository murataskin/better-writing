...
1. Read the brief before editing.
   ...
   - If the user specifies a style profile (e.g. `profiles/legal-araz/PROFILE.md`) or gives a voice sample, treat it as the style source of truth.
...
- `profiles/legal-araz/PROFILE.md`: Turkish legal drafting profile covering civil/labor court petitions (cevap dilekçesi, istinaf, bilirkişi itirazları) AND criminal defense briefs (esas hakkındaki mütalaaya karşı beyan ve savunma dilekçeleri, tevsi-i tahkikat, in dubio pro reo, criminal procedural objections) matching Av. B. İlker Araz's institutional style, structural formulas, non-admission reservations, and few-shot exemplars.
